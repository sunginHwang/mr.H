...
const apiUserRegister = (userId, password, userName, email) => axiosAuth.post(`/api/auth/register`,{userId : userId, userPassword : password, userName : userName, userEmail: email });
